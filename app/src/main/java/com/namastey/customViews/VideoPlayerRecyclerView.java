...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<DashboardBean> mediaObjects = new ArrayList<>();
...
//        VideoPlayerViewHolder holder = (VideoPlayerViewHolder) child.getTag();
        ...
        thumbnail = holder.mediaCoverImage;
//        progressBar = holder.progressBar;
//        volumeControl = holder.volumeControl;
        viewHolderParent = holder.itemView;
//        requestManager = holder.requestManager;
        frameLayout = holder.itemView.findViewById(R.id.mediaContainer);
...
//            }
    ...
    public void setMediaObjects(ArrayList<DashboardBean> mediaObjects){
