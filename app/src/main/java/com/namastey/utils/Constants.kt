...
//    }
    ...
    const val SUPER_MESSAGE_USE = "super-message-use"
    const val FEED_LIST_V2 = "feed-list-v2"
    const val INVITE_USER = "invite-user"
    const val DYNAMIC_LINK = "https://www.namasteyapp.com/earlyaccess/?username="
    ...
    const val KEY_VIDEO_FROM_YOU_FOLLOW = "KEY_VIDEO_FROM_YOU_FOLLOW"
    const val KEY_NOTIFICATION_IS_MESSAGE = "KEY_NOTIFICATION_IS_MESSAGE"
    ...
    const val KEY_ACTIVE_TIME = "KEY_ACTIVE_TIME"
    const val KEY_ACTIVE_BOOST = "KEY_ACTIVE_BOOST"
    ...
    const val KEY_NO_OF_SUPER_MESSAGE = "KEY_NO_OF_SUPER_MESSAGE"
    ...
    const val IS_MESSAGE = "is_message"
    const val IS_VIDEO_SUGGEST = "is_video_suggest"
