...
public class SplashView extends View {
  ...
  public static final int DEFAULT_ICON_COLOR = Color.rgb(254, 0, 0);
  ...
  private void setupAttributes(AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.NamasteySplashView);

    int numAttrs = a.getIndexCount();
    for (int i = 0; i < numAttrs; ++i) {
      int attr = a.getIndex(i);
      switch (attr) {
      case R.styleable.NamasteySplashView_icon:
        setIconDrawable(a.getDrawable(i));
        break;
      case R.styleable.NamasteySplashView_iconColor:
        setIconColor(a.getColor(i, DEFAULT_ICON_COLOR));
        break;
      case R.styleable.NamasteySplashView_holeFillColor:
        setHoleFillColor(a.getColor(i, DEFAULT_HOLE_FILL_COLOR));
        break;
      case R.styleable.NamasteySplashView_duration:
        setDuration(a.getInt(i, DEFAULT_DURATION));
        break;
      case R.styleable.NamasteySplashView_removeFromParentOnEnd:
