package com.namastey.autoPlay

import android.graphics.Rect
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.namastey.adapter.FeedAdapter
import com.namastey.player.InstaLikePlayerView
...
class VideoAutoPlayHelper(var recyclerView: RecyclerView) {
    ...
    private fun attachVideoPlayerAt(pos: Int) {
        val feedViewHolder: FeedAdapter.FeedViewHolder =
            (recyclerView.findViewHolderForAdapterPosition(pos) as FeedAdapter.FeedViewHolder?)!!
