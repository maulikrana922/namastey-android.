...
class ViewModelFactory @Inject constructor(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(PersonalizeDataViewModel::class.java) -> PersonalizeDataViewModel(
                networkService,
                dbHelper,
                baseView
            ) as T
            ...
            modelClass.isAssignableFrom(InAppPurchaseViewModel::class.java) -> InAppPurchaseViewModel(
                networkService,
                dbHelper,
                baseView
            ) as T
            modelClass.isAssignableFrom(InviteViewModel::class.java) -> InviteViewModel(
                networkService,
                dbHelper,
                baseView
            ) as T
            modelClass.isAssignableFrom(AddVideoViewModel::class.java) -> AddVideoViewModel(
                networkService,
                dbHelper,
                baseView
            ) as T
            modelClass.isAssignableFrom(ProfilePicViewModel::class.java) -> ProfilePicViewModel(
                networkService,
                dbHelper,
                baseView
            ) as T
